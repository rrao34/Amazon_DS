...
public class IsStringIsValidNumber {
	...
	public boolean isValidNumeric(String str) {
		...
		// Check if a '.' or 'e' is found in given string. We use this flag to make sure
		// that either of them appear only once.
	...
	public static void main(String[] args) {
		String input = "0.1e10";
		IsStringIsValidNumber validNumObj = new IsStringIsValidNumber();
		System.out.println(validNumObj.isValidNumeric(input));
	}
}
